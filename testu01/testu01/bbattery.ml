...
external repeat_small_crush : Unif01.gen -> int array -> unit = "caml_bbattery_RepeatSmallCrush"

let ntests_small_crush = 10

let repeat_small_crush gen rep =
  if Array.length rep <> ntests_small_crush + 1 then invalid_arg "wrong size for repeat array";
...
external repeat_crush : Unif01.gen -> int array -> unit = "caml_bbattery_RepeatCrush"
...
external repeat_big_crush : Unif01.gen -> int array -> unit = "caml_bbattery_RepeatBigCrush"
...
external repeat_rabbit : Unif01.gen -> float -> int array -> unit = "caml_bbattery_RepeatRabbit"
...
external repeat_alphabit : Unif01.gen ->
float ->
int ->
int ->
int array ->
...
let repeat_alphabit gen nb r s rep =
  if Array.length rep <> ntests_alphabit + 1 then failwith "wrong size for repeat array";
...
external repeat_block_alphabit : Unif01.gen ->
float ->
int ->
int ->
int array ->
int ->
unit = "camlbytecode_bbattery_RepeatBlockAlphabit" "caml_bbattery_RepeatBlockAlphabit"
